...
[![](https://cdn.nlark.com/yuque/0/2023/png/38953059/1699235875833-0b782035-d46c-4117-bdf2-2afde6837482.png)](https://cdn.nlark.com/yuque/0/2023/png/38953059/1699235875833-0b782035-d46c-4117-bdf2-2afde6837482.png)
...
为当前实体类在编译期设置对应的**get/set方法**，**无参/无参构造方法**，**toString方法**，**hashCode方法**，**equals方法**等。
...
MyBatis Plus 提供了一些内置的拦截器，以支持常见的场景，如分页、乐观锁、性能分析等。
...
这些拦截器可以单独使用，也可以组合使用，根据具体的业务需求和场景进行配置。通过这些拦截器，MyBatis Plus 提供了一种灵活而强大的机制来扩展和定制数据访问层的行为。
